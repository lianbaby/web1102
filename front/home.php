...
$(".box").eq(0).show();
    ...
    $(".tab").on("click",(e)=>{
        $(".tab").removeClass('active'); //先全部移除bgc白色
        $(e.target).addClass('active'); //有點到才執行白色bg
        $(".box").hide();
